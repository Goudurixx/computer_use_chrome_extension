...
# install client websocket/anthropic requirements used by the background bridge server
COPY --chown=$USERNAME:$USERNAME client/requirements.txt $HOME/client/requirements.txt
RUN python -m pip install -r $HOME/client/requirements.txt
